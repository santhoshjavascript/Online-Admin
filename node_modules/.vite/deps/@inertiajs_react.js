...
var se2 = (0, import_react3.createContext)(void 0);
se2.displayName = "InertiaHeadContext";
var B2 = se2;
var ae2 = (0, import_react4.createContext)(void 0);
ae2.displayName = "InertiaPageContext";
var N2 = ae2;
function _({ children: p2, initialPage: n, initialComponent: s2, resolveComponent: a, titleCallback: i, onHeadUpdate: f2 }) {
  let [u2, m] = (0, import_react2.useState)({ component: s2 || null, page: n, key: null }), d = (0, import_react2.useMemo)(() => Ie(typeof window > "u", i || ((c) => c), f2 || (() => {
  })), []);
  if ((0, import_react2.useEffect)(() => {
    Wr.init({ initialPage: n, resolveComponent: a, swapComponent: async ({ component: c, page: e, preserveState: l }) => {
      m((t) => ({ component: c, page: e, key: l ? t.key : Date.now() }));
    } }), Wr.on("navigate", () => d.forceUpdate());
  }, []), !u2.component) return (0, import_react2.createElement)(B2.Provider, { value: d }, (0, import_react2.createElement)(N2.Provider, { value: u2.page }, null));
  let g2 = p2 || (({ Component: c, props: e, key: l }) => {
    let t = (0, import_react2.createElement)(c, { key: l, ...e });
    return typeof c.layout == "function" ? c.layout(t) : Array.isArray(c.layout) ? c.layout.concat(t).reverse().reduce((h, S) => (0, import_react2.createElement)(S, { children: h, ...e })) : t;
  });
  return (0, import_react2.createElement)(B2.Provider, { value: d }, (0, import_react2.createElement)(N2.Provider, { value: u2.page }, g2({ Component: u2.component, key: u2.key, props: u2.page.props })));
}
_.displayName = "Inertia";
async function pe2({ id: p2 = "app", resolve: n, setup: s2, title: a, progress: i = {}, page: f2, render: u2 }) {
  let m = typeof window > "u", d = m ? null : document.getElementById(p2), g2 = f2 || JSON.parse(d.dataset.page), c = (t) => Promise.resolve(n(t)).then((h) => h.default || h), e = [], l = await Promise.all([c(g2.component), Wr.decryptHistory().catch(() => {
  })]).then(([t]) => s2({ el: d, App: _, props: { initialPage: g2, initialComponent: t, resolveComponent: c, titleCallback: a, onHeadUpdate: m ? (h) => e = h : null } }));
  if (!m && i && Ne(i), m) {
    let t = await u2((0, import_react.createElement)("div", { id: p2, "data-page": JSON.stringify(g2) }, l));
    return { head: e, body: t };
  }
}
function q2() {
  let p2 = (0, import_react6.useContext)(N2);
  if (!p2) throw new Error("usePage must be used within the Inertia component");
  return p2;
}
var ue = ({ children: p2, data: n, fallback: s2 }) => {
  if (!n) throw new Error("`<Deferred>` requires a `data` prop to be a string or array of strings");
  let [a, i] = (0, import_react5.useState)(false), f2 = q2().props, u2 = Array.isArray(n) ? n : [n];
  return (0, import_react5.useEffect)(() => {
    i(u2.every((m) => f2[m] !== void 0));
  }, [f2, u2]), a ? p2 : s2;
};
ue.displayName = "InertiaDeferred";
var Oe2 = ue;
var He2 = function({ children: p2, title: n }) {
  let s2 = (0, import_react7.useContext)(B2), a = (0, import_react7.useMemo)(() => s2.createProvider(), [s2]);
  ...
  function f2(e) {
    let l = Object.keys(e.props).reduce((t, h) => {
  ...
  function u2(e) {
    return typeof e.props.children == "string" ? e.props.children : e.props.children.reduce((l, t) => l + m(t), "");
  }
  function m(e) {
    let l = f2(e);
    return e.props.children && (l += u2(e)), e.props.dangerouslySetInnerHTML && (l += e.props.dangerouslySetInnerHTML.__html), i(e) || (l += `</${e.type}>`), l;
  }
  function d(e) {
  ...
  function c(e) {
    let l = import_react7.default.Children.toArray(e).filter((t) => t).map((t) => g2(t));
    return n && !l.find((t) => t.startsWith("<title")) && l.push(`<title inertia>${n}</title>`), l;
  }
  return a.update(c(p2)), null;
};
var Be2 = He2;
var R2 = () => {
};
var de2 = (0, import_react8.forwardRef)(({ children: p2, as: n = "a", data: s2 = {}, href: a, method: i = "get", preserveScroll: f2 = false, preserveState: u2 = null, replace: m = false, only: d = [], except: g2 = [], headers: c = {}, queryStringArrayFormat: e = "brackets", async: l = false, onClick: t = R2, onCancelToken: h = R2, onBefore: S = R2, onStart: I2 = R2, onProgress: E = R2, onFinish: Q2 = R2, onCancel: U2 = R2, onSuccess: Y2 = R2, onError: M2 = R2, prefetch: F2 = false, cacheFor: b2 = 0, ...z2 }, G2) => {
  let [X2, $2] = (0, import_react8.useState)(0), L2 = (0, import_react8.useRef)(null);
  n = n.toLowerCase(), i = typeof a == "object" ? a.method : i.toLowerCase();
  let [A2, Z2] = Te(i, typeof a == "object" ? a.url : a || "", s2, e), D2 = A2;
  s2 = Z2;
  let W2 = { data: s2, method: i, preserveScroll: f2, preserveState: u2 ?? i !== "get", replace: m, only: d, except: g2, headers: c, async: l }, K2 = { ...W2, onCancelToken: h, onBefore: S, onStart(r4) {
    $2((O2) => O2 + 1), I2(r4);
  }, onProgress: E, onFinish(r4) {
    $2((O2) => O2 - 1), Q2(r4);
  }, onCancel: U2, onSuccess: Y2, onError: M2 }, H = () => {
    Wr.prefetch(D2, W2, { cacheFor: ee2 });
  }, k2 = (0, import_react8.useMemo)(() => F2 === true ? ["hover"] : F2 === false ? [] : Array.isArray(F2) ? F2 : [F2], Array.isArray(F2) ? F2 : [F2]), ee2 = (0, import_react8.useMemo)(() => b2 !== 0 ? b2 : k2.length === 1 && k2[0] === "click" ? 0 : 3e4, [b2, k2]);
  (0, import_react8.useEffect)(() => () => {
    clearTimeout(L2.current);
  }, []), (0, import_react8.useEffect)(() => {
    k2.includes("mount") && setTimeout(() => H());
  }, k2);
  let o2 = { onClick: (r4) => {
    t(r4), Me(r4) && (r4.preventDefault(), Wr.visit(D2, K2));
  } }, y2 = { onMouseEnter: () => {
    ...
    clearTimeout(L2.current);
  }, onClick: o2.onClick }, P2 = { onMouseDown: (r4) => {
    Me(r4) && (r4.preventDefault(), H());
  }, onMouseUp: (r4) => {
    r4.preventDefault(), Wr.visit(D2, K2);
  }, onClick: (r4) => {
    t(r4), Me(r4) && r4.preventDefault();
  } };
  return i !== "get" && (n = "button"), (0, import_react8.createElement)(n, { ...z2, ...{ a: { href: D2 }, button: { type: "button" } }[n] || {}, ref: G2, ...k2.includes("hover") ? y2 : k2.includes("click") ? P2 : o2, "data-loading": X2 > 0 ? "" : void 0 }, p2);
});
de2.displayName = "InertiaLink";
var We2 = de2;
function V2(p2, n) {
  let [s2, a] = (0, import_react10.useState)(() => {
    let i = Wr.restore(n);
...
function Pe2(p2, n) {
  let s2 = (0, import_react9.useRef)(null), a = typeof p2 == "string" ? p2 : null, [i, f2] = (0, import_react9.useState)((typeof p2 == "string" ? n : p2) || {}), u2 = (0, import_react9.useRef)(null), m = (0, import_react9.useRef)(null), [d, g2] = a ? V2(i, `${a}:data`) : (0, import_react9.useState)(i), [c, e] = a ? V2({}, `${a}:errors`) : (0, import_react9.useState)({}), [l, t] = (0, import_react9.useState)(false), [h, S] = (0, import_react9.useState)(false), [I2, E] = (0, import_react9.useState)(null), [Q2, U2] = (0, import_react9.useState)(false), [Y2, M2] = (0, import_react9.useState)(false), F2 = (0, import_react9.useRef)((o2) => o2);
  (0, import_react9.useEffect)(() => (s2.current = true, () => {
    s2.current = false;
  }), []);
  let b2 = (0, import_react9.useCallback)((...o2) => {
    let y2 = typeof o2[0] == "object", P2 = y2 ? o2[0].method : o2[0], C2 = y2 ? o2[0].url : o2[1], r4 = (y2 ? o2[1] : o2[2]) ?? {}, O2 = { ...r4, onCancelToken: (T2) => {
      if (u2.current = T2, r4.onCancelToken) return r4.onCancelToken(T2);
    }, onBefore: (T2) => {
      if (U2(false), M2(false), clearTimeout(m.current), r4.onBefore) return r4.onBefore(T2);
    }, onStart: (T2) => {
      if (S(true), r4.onStart) return r4.onStart(T2);
    }, onProgress: (T2) => {
      if (E(T2), r4.onProgress) return r4.onProgress(T2);
    }, onSuccess: (T2) => {
      if (s2.current && (S(false), E(null), e({}), t(false), U2(true), M2(true), f2((0, import_lodash.default)(d)), m.current = setTimeout(() => {
        s2.current && M2(false);
      }, 2e3)), r4.onSuccess) return r4.onSuccess(T2);
    }, onError: (T2) => {
      if (s2.current && (S(false), E(null), e(T2), t(true)), r4.onError) return r4.onError(T2);
    }, onCancel: () => {
      if (s2.current && (S(false), E(null)), r4.onCancel) return r4.onCancel();
    }, onFinish: (T2) => {
      if (s2.current && (S(false), E(null)), u2.current = null, r4.onFinish) return r4.onFinish(T2);
    } };
    P2 === "delete" ? Wr.delete(C2, { ...O2, data: F2.current(d) }) : Wr[P2](C2, F2.current(d), O2);
  }, [d, e, F2]), z2 = (0, import_react9.useCallback)((o2, y2) => {
    g2(typeof o2 == "string" ? (P2) => ({ ...P2, [o2]: y2 }) : typeof o2 == "function" ? (P2) => o2(P2) : o2);
  }, [g2]), G2 = (0, import_react9.useCallback)((o2, y2) => {
    f2(typeof o2 > "u" ? () => d : (P2) => ({ ...P2, ...typeof o2 == "string" ? { [o2]: y2 } : o2 }));
  }, [d, f2]), X2 = (0, import_react9.useCallback)((...o2) => {
    o2.length === 0 ? g2(i) : g2((y2) => Object.keys(i).filter((P2) => o2.includes(P2)).reduce((P2, C2) => (P2[C2] = i[C2], P2), { ...y2 }));
  }, [g2, i]), $2 = (0, import_react9.useCallback)((o2, y2) => {
    e((P2) => {
      let C2 = { ...P2, ...typeof o2 == "string" ? { [o2]: y2 } : o2 };
      return t(Object.keys(C2).length > 0), C2;
    });
  }, [e, t]), L2 = (0, import_react9.useCallback)((...o2) => {
    e((y2) => {
      let P2 = Object.keys(y2).reduce((C2, r4) => ({ ...C2, ...o2.length > 0 && !o2.includes(r4) ? { [r4]: y2[r4] } : {} }), {});
      return t(Object.keys(P2).length > 0), P2;
    });
  }, [e, t]), A2 = (o2) => (y2, P2) => {
    b2(o2, y2, P2);
  }, Z2 = (0, import_react9.useCallback)(A2("get"), [b2]), D2 = (0, import_react9.useCallback)(A2("post"), [b2]), W2 = (0, import_react9.useCallback)(A2("put"), [b2]), K2 = (0, import_react9.useCallback)(A2("patch"), [b2]), H = (0, import_react9.useCallback)(A2("delete"), [b2]), k2 = (0, import_react9.useCallback)(() => {
    u2.current && u2.current.cancel();
  }, []), ee2 = (0, import_react9.useCallback)((o2) => {
    F2.current = o2;
  }, []);
  return { data: d, setData: z2, isDirty: !(0, import_lodash2.default)(d, i), errors: c, hasErrors: l, processing: h, progress: I2, wasSuccessful: Q2, recentlySuccessful: Y2, transform: ee2, setDefaults: G2, reset: X2, setError: $2, clearErrors: L2, submit: b2, get: Z2, post: D2, put: W2, patch: K2, delete: H, cancel: k2 };
}
function ye2(p2, n = {}, s2 = { keepAlive: false, autoStart: true }) {
  let a = (0, import_react11.useRef)(Wr.poll(p2, n, { ...s2, autoStart: false }));
  return (0, import_react11.useEffect)(() => ((s2.autoStart ?? true) && a.current.start(), () => a.current.stop()), []), { stop: a.current.stop, start: a.current.start };
}
function he2(p2 = {}) {
  let n = typeof window > "u" ? null : Wr.getCached(window.location.pathname, p2), s2 = typeof window > "u" ? null : Wr.getPrefetching(window.location.pathname, p2), [a, i] = (0, import_react12.useState)((n == null ? void 0 : n.staleTimestamp) || null), [f2, u2] = (0, import_react12.useState)(s2 !== null), [m, d] = (0, import_react12.useState)(n !== null);
  return (0, import_react12.useEffect)(() => {
    let g2 = Wr.on("prefetching", (e) => {
      e.detail.visit.url.pathname === window.location.pathname && u2(true);
    }), c = Wr.on("prefetched", (e) => {
      e.detail.visit.url.pathname === window.location.pathname && (u2(false), d(true), i(e.detail.fetchedAt));
    });
    return () => {
      c(), g2();
    };
  }, []), { lastUpdatedAt: a, isPrefetching: f2, isPrefetched: m, flush: () => Wr.flush(window.location.pathname, p2) };
}
var Se2 = ({ children: p2, data: n, params: s2, buffer: a, as: i, always: f2, fallback: u2 }) => {
  f2 = f2 ?? false, i = i ?? "div", u2 = u2 ?? null;
  let [m, d] = (0, import_react13.useState)(false), g2 = (0, import_react13.useRef)(false), c = (0, import_react13.useRef)(false), e = (0, import_react13.useRef)(null), l = (0, import_react13.useCallback)(() => {
  ...
  return (0, import_react13.useEffect)(() => {
    ...
    let t = new IntersectionObserver((h) => {
      if (!h[0].isIntersecting || (!f2 && g2.current && t.disconnect(), c.current)) return;
      g2.current = true, c.current = true;
      let S = l();
      Wr.reload({ ...S, onStart: (I2) => {
        var _a;
        c.current = true, (_a = S.onStart) == null ? void 0 : _a.call(S, I2);
      }, onFinish: (I2) => {
        var _a;
        d(true), c.current = false, (_a = S.onFinish) == null ? void 0 : _a.call(S, I2), f2 || t.disconnect();
      } });
    }, { rootMargin: `${a || 0}px` });
    return t.observe(e.current), () => {
      t.disconnect();
    };
  }, [e, l, a]), f2 || !m ? (0, import_react13.createElement)(i, { props: null, ref: e }, m ? p2 : u2) : m ? p2 : null;
};
Se2.displayName = "InertiaWhenVisible";
var nt2 = Se2;
var br = Wr;
export {
  Oe2 as Deferred,
